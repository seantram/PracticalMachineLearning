...
####2.3 Data Processing:
To prepare the data, I remove the seven first variables that I think are not useful for modeling, then I remove all variables that have more than 50% of missing observations.
...
On the testiong dataset the Accuracy of the "rf" model is 0.992 and the 95% confidence interval is (0.99, 0.994)
